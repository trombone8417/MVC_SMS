...
using RecruitmentSystemMgt.Models;
using RecruitmentSystemMgt.Repository;
using RecruitmentSystemMgt.ViewModels;
using System;
...
namespace RecruitmentSystemMgt.Controllers
{
    public class ResumeController : Controller
    {
        ...
        public ActionResult CheckCV()
        {
            ...
            {
                var people = db.People.Where(p => p.EmpID == employeeid);
                if (people != null)
                {
                    if (people.Count() > 0)
                    {
